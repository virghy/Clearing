...
namespace Sorteable
{
    ...
    public class DataGridViewAutoFilterColumnHeaderCell : DataGridViewColumnHeaderCell
    {
      ...
      //  public delegate void TotalizarEventHandler(object sender, EventArgs e);

        public event EventHandler Totalizar;
        ...
        private void DropDownListBox_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            //VG para que nos permita sumar los totales
            base.RaiseCellContentDoubleClick(new DataGridViewCellEventArgs(-1, -1));
           
            
            //base.DataGridView.
           // base.OnMouseLeave(-99);
           // base.DataGridView.MouseDow
        ...
        private void PopulateFilters()
        {
            ...
            {
                filters.Add("(Vacios)", null);
                filters.Add("(No Vacios)", null);
            }
        }
        ...
        private void UpdateFilter()
        {
            ...
            // If the user selection is (Todos), remove any filter currently 
