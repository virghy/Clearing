...
namespace Sorteable
{
    ...
    public class FilteredBindingList<T> : BindingList<T>, IBindingListView where T : System.Data.Objects.DataClasses.EntityObject
    {
        private ObjectContext context;
        public FilteredBindingList(ObjectContext context)
            : base()
        {
        ...
        {
            //Limpiamos la lista original del filtro
            originalListValue.Clear();
            ...
            ListSortDirection direction)
        {
          ...
          //  {
                ...
                unsortedItems = new FilteredBindingList<T>(context);
...
set
{
    ...
    else
    {
        ...
        matches = value.Split(new string[] { " AND " }, 
            StringSplitOptions.RemoveEmptyEntries);
        }
            else
        {
                 matches = value.Split(new string[] { " OR " },
            StringSplitOptions.RemoveEmptyEntries);
...
public class DinoComparer : IComparer<Nullable<decimal>>
{
    public int Compare(Nullable<decimal> x, Nullable<decimal> y)
    {
        if (x == null)
        {
            if (y == null)
