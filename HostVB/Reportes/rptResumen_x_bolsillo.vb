Public Class rptResumen_x_bolsillo
    ...
    Private Sub rptResumen_x_bolsillo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'DsReportes.Lecturas_x_bolsillo' Puede moverla o quitarla según sea necesario.
        '      Me.Lecturas_x_bolsilloTableAdapter.Fill(Me.DsReportes.Lecturas_x_bolsillo)
