...
Public Class frmRecibido
    ...
    Sub New(ByVal Camara As String, ByVal Maquina As String, ByVal Operacion As Operacion)
        ...
        Me.DataGridViewTextBoxColumn1.FilteringEnabled = True
        Me.DataGridViewTextBoxColumn7.FilteringEnabled = True
        ...
        Me.DataGridViewTextBoxColumn27.FilteringEnabled = True
    ...
    Sub PonerTitulos()
        ...
        End Select
        Dim obj As Bancos = (From bc In Bancos Where bc.cod_banco = codBanco Select bc).FirstOrDefault
    ...
    Private Sub validar()
        ...
        For Each item As DataGridViewRow In LecturasDataGridView.Rows
            ...
            If Not lc.EsCabecera And Me.Oper = Operacion.Devuelto Then
                If lc.cuenta_cheque = 1 Then
            ...
            If Not lc.EsCabecera Then
                ...
                Else
                    ...
                    If Existe.Importe <> lc.monto Then
                        ...
                        lc.AgregarError(16, "Monto no corresponde con el CREC.")
                        ExisteError = True
                    End If
                End If
            End If
